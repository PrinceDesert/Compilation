...
{
      16,    -7,    -8,    -8,    35,     6,    23,    -8,    29,    -8,
      -1,    -8,    42,     9,    35,    35,    35,    35,    35,    -8,
      -8,    -8,    -8,    -8,    -3,    -3,    -8,    -8,    -8
};
...
{
       0,     0,    15,     8,     0,     0,     0,     4,     0,     1,
       0,     6,     0,     0,     0,     0,     0,     0,     0,     7,
       9,     2,     5,     3,    10,    11,    12,    13,    14
};
...
{
       8,    12,     7,    16,    17,    18,     9,    10,    21,     2,
      24,    25,    26,    27,    28,    11,     4,     1,    23,     2,
       0,     0,     0,     0,    13,     3,     4,    14,    15,    16,
      17,    18,    19,    14,    15,    16,    17,    18,     2,     0,
      20,     0,     0,     0,     0,     4,    14,    15,    16,    17,
      18,    22
};
...
{
       4,     5,     9,     6,     7,     8,     0,     1,     9,     3,
      14,    15,    16,    17,    18,     9,    10,     1,     9,     3,
      -1,    -1,    -1,    -1,     1,     9,    10,     4,     5,     6,
       7,     8,     9,     4,     5,     6,     7,     8,     3,    -1,
      11,    -1,    -1,    -1,    -1,    10,     4,     5,     6,     7,
       8,     9
};
...
{
       0,     1,     3,     9,    10,    13,    14,     9,    14,     0,
       1,     9,    14,     1,     4,     5,     6,     7,     8,     9,
      11,     9,     9,     9,    14,    14,    14,    14,    14
};
...
#line 41 "ex1.y"
                                  {
			/* $1 = expr, $2 = '+', $3 = expr */
			if ((yyvsp[-2].state) == VALID && (yyvsp[0].state) == VALID) {
...
#line 65 "ex1.y"
			...
			if ((yyvsp[-2].state) == VALID && (yyvsp[0].state) == VALID && stack[stack_size - 1] != 0) {
